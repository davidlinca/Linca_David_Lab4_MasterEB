...
namespace Linca_David_Lab4_MasterEB
{
    public partial class PricePredictionModel
    {
        public const string RetrainFilePath =  @"C:\Users\ASUS\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=1267,NumberOfIterations=582,MinimumExampleCountPerLeaf=20,LearningRate=0.9999997766729865,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9937641334684788,L1Regularization=1.4877254054020078E-09,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=253}));
